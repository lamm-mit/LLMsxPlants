...
def conversation_simulator_LlamaIndex(
    ...
    question_gpt_name='Engineer',answer_gpt_name='BioinspiredLLM', answer_instructions='You answer correctly.',
    ...
    for _ in range(total_turns):
        ...
        if single_shot_question: 
            q=f"""{txt}\n\n{marker_ch_outer} Briefly suggest specific refinements to improve the scientific validity of the procedure."""
...
Outline the final, refined procedure using the conversation as additional context. Remove any unncessary details or materials while filling in any crucial missing details. 
